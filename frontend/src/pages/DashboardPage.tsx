...
import { AlertTriangle, Sparkles, Activity, Wind, Thermometer, Droplets } from 'lucide-react';
...
export const DashboardPage: React.FC = () => {
  ...
  useRealtimeSubscription<PollutionReading>('pollution_readings', (newReading) => {
    ...
    loadData(); // refresh overview counts
  });
  ...
  const primaryLoc = summary.locations[0] || {};
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
        <div className="card flex flex-col items-center justify-center">
          <AQIGauge
            ...
            dominantPollutant={primaryLoc.dominant_pollutant}
            size="lg"
          />
        </div>
